...
-- Basic keymaps for editing
vim.keymap.set('i', 'jj', '<esc>',ops) -- Exit insert mode with 'jj'
vim.keymap.set('x', '<leader>p', [["_dP]], ops) -- Paste over selection without yanking
vim.keymap.set({ 'n', 'v' }, '<leader>du', [["_d]], ops) -- Delete without yanking
...
vim.keymap.set('n', '<C-h>', '<C-w><C-h>', { desc = 'Move to left window' }) -- Window navigation
